  ...
  return (
    <div className="mb-6 font-inter ">
      ...
      <select
        ...
        className="p-2 border border-gray-300 rounded focus:ring-1 focus:ring-gray-400 focus:outline-none cursor-pointer"
      >
        <option value="featured" className="cursor-pointer">
          Featured
        </option>
